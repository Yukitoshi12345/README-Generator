...
const questions = [
...

  {
    ...
    message:
      "Walk me through the installation instruction someone needs to take to set up this project.",
    type: "input",
  },
...
function writeToFile(fileName, data) {
  fs.writeFile(fileName, data, (err) => {
    err
      ? console.log(err)
      : console.log("Your new README is ready to guide the world!");
  });
}
...
function init() {
  inquirer
    ...
    .catch((error) =>
      console.error("Failed to generate a README file: ", error)
    );
}

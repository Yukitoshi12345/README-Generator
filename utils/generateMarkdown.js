...
function renderLicenseBadge(license) {
  ...
  if (license === "Apache 2.0") {
    ...
    badge =
      "![BSL 1.0 licence badge](https://img.shields.io/badge/License-BSL_1.0-orange.svg)";
  } else if (license === "BSD 2.0") {
    badge =
      "![BSD 2.0 licence badge](https://img.shields.io/badge/License-BSD_2.0-orange.svg)";
    ...
    badge =
      "![CC0 1.0 licence badge](https://img.shields.io/badge/License-CC0_1.0-orange.svg)";
  } else if (license === "GPL 2.0") {
    badge =
      "![GPL 2.0 licence badge](https://img.shields.io/badge/License-GPL_2.0-blue.svg)";
  } else if (license === "GPL 2.1") {
    badge =
      "![GPL 2.1 licence badge](https://img.shields.io/badge/License-GPL_2.1-blue.svg)";
  } else if (license === "GPL 3.0") {
    badge =
      "![GPL 3.0 licence badge](https://img.shields.io/badge/License-GPL_3.0-blue.svg)";
    ...
    badge =
      "![EPL 2.0 licence badge](https://img.shields.io/badge/License-EPL_2.0-blue.svg)";
  } else if (license === "MIT") {
    badge =
      "![MIT licence badge](https://img.shields.io/badge/License-MIT-green.svg)";
  } else if (license === "MPL 2.0") {
    badge =
      "![MPL 2.0 licence badge](https://img.shields.io/badge/License-MPL_2.0-blue.svg)";
  } else if (license === "The Unlicense") {
    badge =
      "![The Unlicense licence badge](https://img.shields.io/badge/License-The_Unlicense-Gray.svg)";
  } else if (license === "None") {
    badge =
      "![None licence badge](https://img.shields.io/badge/License-None-red.svg)";
  } else {
